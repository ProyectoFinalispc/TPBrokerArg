from src.servicios.inversor_serv import InversorService
from src.servicios.portafolio_serv import PortafolioService
from src.modelos.inversor import Inversor
from src.modelos.portafolio import Portafolio
